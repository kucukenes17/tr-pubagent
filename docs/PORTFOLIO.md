...
- Transferred the benchmark to actual Chromium through Playwright: Rule Guard improved Phi-4 completion from 0/40 to 25/40, eliminated 11 observed state-corruption violations, reduced generated tokens by 53.9%, and ran 2.40× faster (exact McNemar p=5.96×10⁻⁸).
