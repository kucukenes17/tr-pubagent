...
| ML Guard / Hybrid Guard ablation | Tamamlandı | İlk v2 ablation'da üç guarded sistem 66/72; sınıf-ağırlıklı v3 takipte ML/Hybrid 57/72, Rule 66/72; H3 desteklenmedi |
| Sınıf-ağırlıklı ML eğitim yolu | Tamamlandı | XLM-R v3, ağırlıklı çapraz entropi ve 398 test örneğinde macro-F1 1,0; OOD sonucu ayrı sürümde arşivlendi |
